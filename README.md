Данная нейросеть принимает файл типа *.pdf, далее конвертирует постранично в *.png, проверяет, определяет и копирует проверяемый файл в соответствующую папку.
